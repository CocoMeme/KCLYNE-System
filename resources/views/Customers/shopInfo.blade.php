...
@else 
	...
	<section class="main-home" style="height: 100vh; margin: auto">
		<div class="main-text" style="padding-top: 200px">
			<h5 style="font-size: 20px">KCLYNE</h5>
			<h1 style="color: rgb(74, 83, 118)">LOGIN REQUIRED<br></h1>
			<h1>Notice:</h1>
			<p>Please logged in to access this page.</p>

			<a href="/customer/login" class="main-btn">Login<i class='bx bxs-chevron-right'></i></a>
		</div>
	</section>
